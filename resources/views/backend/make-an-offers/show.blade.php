...
<div class="content-wrapper">
	<div class="container-fluid">
		<section class="content-header">
			<h3>Offer Made <small>view</small></h3>
			<ol class="breadcrumb">
			...
			<div class="col-12">
				<div class="box box-primary">
					...
					<div class="box-body no-padding">
						<div class="mailbox-read-offer">
						<h3>{{ $offer->name ?? '(empty)' }}</h3>
						<h5>From: <a href="{{ url('/single-car-product', $offer->id) }}">{{ url('/single-car-product', $offer->id) }}</a>
							<span class="mailbox-read-time pull-right">{{ $offer->created_at->format('jS M Y') }}</span></h5>
						</div>
						<!-- /.mailbox-read-offer -->
